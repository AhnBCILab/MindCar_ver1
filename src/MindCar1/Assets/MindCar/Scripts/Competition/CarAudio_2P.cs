...
public class CarAudio_2P : MonoBehaviour
{
    ...
    {
        // --------------------------------------------------------------------------
        var cam = GameObject.Find("Camera/Second_Cam").GetComponent<CameraControl>();
        m_CarController = cam.CarVelocity * 1.5f;
        //print("CarVelocity 1P : " + m_CarController);
        // ---------------------------------------------------------------------------
