...
public class Ind_CarAudio : MonoBehaviour  
{
    ...
    private float m_CarController; // Reference to car we are controlling
        ...
        {
            // --------------------------------------------------------------------------
            var cam = GameObject.Find("Camera/First_Cam").GetComponent<Ind_CameraControl>();
            m_CarController = cam.CarVelocity * 1.0f;
            //print("CarVelocity : " + m_CarController);
            // ---------------------------------------------------------------------------
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, m_CarController);
                ...
                else
                {
                    ...
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, m_CarController);
